...
// 18January2008 [jef]
//
Macro "Set Parameters"(folderName)
    ...
    masterTAZFile=modelDirectory+"generic\\inputs\\taz\\Master TAZ Layer.dbd"

    // Set the Baes Year HH distribution file
    baseYearHHFile="c:\\projects\\ompo\\conversion\\application\\generic\\inputs\\taz\\baseyear_hhdistrib.bin"

    // The scenario directory is based on the folderName - could change this convention
    scenarioDirectory=modelDirectory + folderName + "\\inputs\\taz"
...
Macro "Create 2005 TAZ File"

    // Set the Year
    currentYear = "2005"

    // Set the folder name
    folderName = "2005_base"

    TAZDataFile = "c:\\projects\\ompo\\conversion\\application\\generic\\inputs\\taz\\2005\\y2005tazdata.xls"
...
Macro "Create 2015 TAZ File"
    ...
    TAZDataFile = "c:\\projects\\ompo\\conversion\\application\\generic\\inputs\\taz\\2015\\z15hct6p(071128)modified547548.xls"
...
Macro "Create 2030 TAZ File"
    ...
    TAZDataFile = "c:\\projects\\ompo\\conversion\\application\\generic\\inputs\\taz\\2030\\z30hct6p(071128)modified547548.xls"
...
Macro "Export TAZ Data" (masterTAZFile,TAZDataFile,scenarioDirectory)
   ...
   SetLayerVisibility(tazLayer,"True")
    ...
    yearView = OpenTable("Year", "EXCEL", {TAZDataFile,"data$"}, {{"Shared", "True"}})
...
Macro "Distribute Households"(baseYearHHFile, scenarioDirectory)
   ...
   // Set the location of the output TAZ data
    ...
    futureYearHHFile = scenarioDirectory+"\\hdistrib.bin"
