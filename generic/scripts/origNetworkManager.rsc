...
Macro "Fill Stop Attributes" (hwyfile, rtsfile, rstopfile)
    ...
    Opts.Input.[Dataview Set] = {{stp_lyr, rtsfile1, {"Route_ID"}, {"Route_ID"}}, "joinedvw111"}                //AB facility type/functional Class is not consistent with BA facility type/functional Class
        Opts.Global.Fields = {stp_lyr+".RTE_NUMBER",stp_lyr+".RTE_NAME",stp_lyr+".MODE",stp_lyr+".AM_HEADWAY",stp_lyr+".MD_HEADWAY",stp_lyr+".PM_HEADWAY"}                           // the field to fill
