...
//    scenarioDirectory = "F:\\projects\\OMPO\\ORTP2009\\A_Model\\2007_100709"
    ...
    dim ablane[1], balane[1], abvoc[1], bavoc[1]    
        ...
        ABATYPE[1] = VectorToArray(GetDataVector(view_name + "|", "[AB ATYPE]",))        // Area Type for AB direction                                                                                                                                                                                                                                                                                                                                                                     
        BAATYPE[1] = GetDataVector(view_name + "|", "[BA ATYPE]",)                       // Area Type for BA direction                                                                                                                                                                                                                                                                                                                                                                     
