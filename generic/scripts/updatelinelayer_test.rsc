...
*
*****************************************************************************/
Macro "Update Line Layer"
    RunMacro("TCB Init")
    scenarioDirectory = "C:\\Projects\\Ompo\\2012_6_calibration"
    ...
    trnpkfactfile=scenarioDirectory + "\\inputs\\other\\tranpktimefac.bin"
    trnopfactfile=scenarioDirectory + "\\inputs\\other\\tranoptimefac.bin"
    nzones=764
