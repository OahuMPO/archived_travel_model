...
Macro "Transit Assignment Home Based Trips" (scenarioDirectory, rtsfile)
    ...
    trn_pktrips = scenarioDirectory+"\\outputs\\trnPeakHB.mtx"
    trn_optrips = scenarioDirectory+"\\outputs\\trnOffPeakHB.mtx"
   ...
   // for every network
    for i = 1 to trnnet.length do
        ...
        outputOnOffTable = scenarioDirectory+"\\outputs\\transitassn\\"+tripFileName+"_"+tripCoreName+"_ONOFF.bin"
        outputLinkFlow = scenarioDirectory+"\\outputs\\transitassn\\"+tripFileName+"_"+tripCoreName+"_LINKFLOW.bin"
